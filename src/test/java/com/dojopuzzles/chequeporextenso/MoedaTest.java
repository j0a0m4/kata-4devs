...
class MoedaTest {
    ...
    void casoTrinta() {
        ...
        assertEquals(new LinhaDoCheque(Dezena.TRINTA, Vintena.ZERO), trintaReais.porExtenso());
    }
    ...
    void casoTrintaUm() {
        ...
        assertEquals(new LinhaDoCheque(Dezena.TRINTA, Vintena.UM), trintaUmReais.porExtenso());
    }
}
